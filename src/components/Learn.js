    ...
    render(){
        return (
            <div class="learn">
                ...
                <div class="learn-tokens" style={{flexFlow: isMobile ? "row wrap" : "row"}}>
                    <Card id="erc20">
                        <CardContent>
                            <h3 class="card-head">ERC20</h3>
                            <span>
